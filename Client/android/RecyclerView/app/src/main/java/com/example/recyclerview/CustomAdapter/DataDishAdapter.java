...
public class DataDishAdapter extends RecyclerView.Adapter<DataDishAdapter.ViewHoler> {
    ...
    Context context;
    Dialog myDialog;
    ArrayList<DataDishDTO> dataDishesTransferToCart =new ArrayList<DataDishDTO>();
    ...
    public class  ViewHoler extends RecyclerView.ViewHolder{
        ...
        public void ShowDialog(final int adapterPosition) {
            ...
            btnAddToCartDialog.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    dataDishesTransferToCart.add(new DataDishDTO(imgDish.toString(),txtName.toString(),txtGia.toString(),txtNumberDialog.toString()));
                    Intent intent = new Intent("custom-message");
                    //            intent.putExtra("quantity",Integer.parseInt(quantity.getText().toString()));
                    intent.putExtra("quantity",dataDishesTransferToCart);
